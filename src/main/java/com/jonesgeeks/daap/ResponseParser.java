...
public class ResponseParser {
   ...
   public static Response performParse(byte[] raw) throws IOException {
      return performParse(new ByteArrayInputStream(raw));
   }
   
   public static Response performParse(InputStream raw) throws IOException {
	   final DataInputStream stream = new DataInputStream(raw);
